...
$ShowTotal=0;
 ...
 // $QUE ="select Name, InVar, OutType, SomonCode 'C equivalent' from DefaultFunctions order by ID desc";
 $QUE ="select ID,Name, InVar, OutType, SomonCode 'C equivalent' from DefaultFunctions order by ID desc";
