...
$ShowTotal=0;
 ...
 $QUE ="select T.ID,T.InVar,$OutValueQue,Name,State,T.TimestampDone,ROUND(Duration/1000,3) 'Duration (s)',T.F from Instances T join PublicFunctions PF on(T.F=PF.ID) where Starter=".$_SESSION['UID']." order by T.ID desc";
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
	...
	<button type="button" class="btn btn-danger" id="Example">Make example</button>
	  ...
	  <script>
		...
		$("#Example").click(function()
		{
			...
			$.post( "phps/Operations.php", {Operation:"MakeExample", PublicID: L(data,"F"),InstanceID: L(data,"ID")}, function( data )
			{
				alert(data);
				//location.reload();
			});
